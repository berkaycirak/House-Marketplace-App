...
function EditListing() {
  ...
  // This use effect here is just getting the user and adding the userRef to the form. Without that useEffect, we can't understand which user is logged in.
  useEffect(() => {
    if (isMounted) {
      ...
      <main>
        <form onSubmit={onSubmit}>
          ...
          <p className='imagesInfo'>
            The first image will be the cover (max 6 and each shouldn't exceed
            2MB).
          </p>
          <input
